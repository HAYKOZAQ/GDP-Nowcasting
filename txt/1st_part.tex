...
any single model delivers?\citep{Netherlands2024}
...
(RMSFE 0.79 versus 0.88).\citep{Netherlands2024} Studies for Armenia
...
capture.\citep{Netherlands2024} Financial market participants constitute
...
\section{Limitations and Critical Perspectives}

The practical value of nowcasting models must be assessed alongside a
clear-eyed awareness of their structural limitations. A fundamental
constraint is data quality: measurement error, subsequent revisions,
definitional reclassifications, and unstable seasonal adjustment
procedures can corrupt the signal extracted from raw indicators, with
these problems being more acute in emerging economies where data
infrastructure is still developing. The estimated relationships between
high-frequency predictors and quarterly GDP are reduced-form in nature
and therefore susceptible to the Lucas critique: a change in policy
regime or in agents' behaviour can alter the co-movement structure that
the model was trained to exploit.\citep{ArmeniaBelarus2024}

Alternative data sources introduce specific risks of their own.
Internet search volumes may be distorted by algorithmic changes to
search platforms, shifts in the demographic composition of internet
users, or the emergence of competing information sources---any of which
can create structural breaks in the relationship between search indices
and the underlying economic phenomena they proxy. Highly flexible
machine learning architectures furthermore risk becoming opaque
``black boxes'' that generate accurate in-sample estimates but lack
interpretability, making them difficult to communicate credibly to
policymakers and potentially prone to overfitting when applied to
economic regimes not represented in the training data. These concerns
strengthen the case for rigorous out-of-sample evaluation, transparent
model documentation, ensemble approaches that diversify across model
families, and the sustained role of informed economic judgement
alongside statistical output.\citep{Netherlands2024}
...
effects.\citep{Netherlands2024} \textit{Recurrent Neural Networks}
...
over 1992Q1--2018Q4.\citep{Netherlands2024} At month-1 of the nowcast
...
\bibitem{Netherlands2024}
Kant, D., Pick, A., \& de Winter, J. (2024).
\textit{Nowcasting GDP using machine learning methods}.
...
\textit{GDP Nowcasting: From Traditional Econometric Models to Machine Learning Algorithms}.
Eurasian Fund for Stabilization and Development, Working Paper WP/25/1.

\bibitem{Georgia2022}
Mgebrishvili, M. (2022).
\textit{Nowcasting with high frequency data, Google trends and machine learning}.
Ministry of Finance of Georgia, Working Paper WP 01/2022.

\bibitem{Peru2024}
Tenorio, J., \& Perez, W. (2024).
\textit{Monthly GDP nowcasting with Machine Learning and Unstructured Data}.
arXiv:2402.04165v1.

\bibitem{US2022}
Kohns, D., \& Bhattacharjee, A. (2022).
\textit{Nowcasting Growth using Google Trends Data: A Bayesian Structural Time Series Model}.
arXiv:2011.00938v2.

\bibitem{Bok2017}
Bok, B., Caratelli, D., Giannone, D., Sbordone, A., \& Tambalotti, A. (2017).
\textit{Macroeconomic Nowcasting and Forecasting with Big Data}.
Federal Reserve Bank of New York, Staff Report No.\ 830.

\bibitem{Anesti2020}
Anesti, N., Galv\~{a}o, A. B., \& Miranda-Agrippino, S. (2020).
\textit{Uncertain Kingdom: Nowcasting GDP and its Revisions}.
