...
os.makedirs('d:/DATA/GDP_NOWCASTING_DASHBOARD/data', exist_ok=True)

# --- Page 1 ---
df1_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p1_1.xlsx')
...
df1_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p1_commodities.csv', index=False, float_format="%.2f")

df1_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p1_3.xlsx')
...
df1_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p1_food.csv', index=False, float_format="%.2f")

# --- Page 2 ---
df2_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p2_1.xlsx')
df2_1 = pd.DataFrame({
...
df2_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p2_tourism_counts.csv', index=False, float_format="%.2f")
...
df2_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p2_tourism_growth.csv', index=False)

# --- Page 3 ---
df3_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p3_1.xlsx')
df3_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p3_2.xlsx')
df3_1 = pd.DataFrame({
...
df3_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p3_remittances.csv', index=False, float_format="%.2f")

# --- Page 4 ---
df4_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p4_1.xlsx')
df4_1 = pd.DataFrame({
    "quarter": ["I", "II", "III", "IV"],
    "eai": list(df4_1_raw.iloc[0, 1:5].values),
    "eai_nosk": list(df4_1_raw.iloc[1, 1:5].values)
})
df4_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p4_eai_quarterly.csv', index=False, float_format="%.2f")
...
df4_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p4_eai_monthly.csv', index=False)

df4_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p4_3.xlsx')
...
df4_3.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p4_sectors.csv', index=False, float_format="%.2f")

# --- Page 5 ---
df5_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p5_1.xlsx')
df5_1 = pd.DataFrame({
    "month": ["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"],
...
df5_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p5_industry.csv', index=False, float_format="%.2f")

df5_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p5_3.xlsx')
df5_2 = pd.DataFrame({
...
df5_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p5_manufacturing.csv', index=False, float_format="%.2f")

# --- Page 6 ---
df6_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p6_1.xlsx')
df6_1 = pd.DataFrame({
...
df6_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p6_agriculture.csv', index=False, float_format="%.2f")

df6_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p6_2.xlsx')
df6_2 = pd.DataFrame({
...
df6_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p6_sectors.csv', index=False, float_format="%.2f")

# --- Page 7 ---
df7_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p7_1.xlsx')
df7_1 = pd.DataFrame({
    "month": ["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"],
...
df7_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p7_construction_monthly.csv', index=False, float_format="%.2f")

df7_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p7_2.xlsx')
df7_2 = pd.DataFrame({
...
df7_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p7_funding.csv', index=False, float_format="%.2f")

df7_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p7_3.xlsx')
df7_3 = pd.DataFrame({
...
df7_3.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p7_sectors.csv', index=False, float_format="%.2f")
...
df8_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p8_1.xlsx')
df8_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p8_2.xlsx')
df8_1 = pd.DataFrame({
    "quarter": q_lbl,
...
df8_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p8_real_estate.csv', index=False, float_format="%.2f")

df8_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p8_3.xlsx')
df8_2 = pd.DataFrame({
...
df8_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p8_permits.csv', index=False, float_format="%.2f")

# --- Page 9 ---
df9_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p9_1.xlsx')
df9_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p9_3.xlsx')
df9_1 = pd.DataFrame({
...
df9_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p9_employment.csv', index=False, float_format="%.2f")

df9_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p9_2.xlsx')
df9_2 = pd.DataFrame({
    "type": ["2024", "2025"], 
    "no_wage": list(df9_2_raw.iloc[0:2, 1].values), 
    "wage": list(df9_2_raw.iloc[0:2, 2].values)
})
df9_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p9_employment_structure.csv', index=False, float_format="%.2f")

# --- Page 10 ---
df10_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p10_1.xlsx')
df10_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p10_2.xlsx')
df10_1 = pd.DataFrame({
    "period": ["I եռ.", "II եռ.", "III եռ.", "IV եռ.", " ", "Տարեկան"],
...
df10_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p10_unemployment.csv', index=False, float_format="%.2f")

df10_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p10_3.xlsx')
df10_2 = pd.DataFrame({
...
df10_2.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p10_changes.csv', index=False, float_format="%.2f")

df10_4_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p10_4.xlsx')
df10_3 = pd.DataFrame({
    "month": ["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII"],
    "r25": list(df10_4_raw.iloc[1, 1:13].values),
    "r24": list(df10_4_raw.iloc[0, 1:13].values)
})
df10_3.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p10_registered.csv', index=False, float_format="%.2f")

# --- Page 11 ---
df11_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p11_1.xlsx')
df11_2_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p11_2.xlsx')
df11_3_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p11_3.xlsx')
df11_1 = pd.DataFrame({
    "period": ["I եռ.", "II եռ.", "III եռ.", "IV եռ.", " ", "Տարեկան"],
...
df11_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p11_labor_resources.csv', index=False, float_format="%.2f")

# --- Page 12 ---
df12_1_raw = pd.read_excel('d:/DATA/GDP_NOWCASTING_DASHBOARD/data_xlsx/p12_1.xlsx')
df12_1 = pd.DataFrame({
...
df12_1.to_csv('d:/DATA/GDP_NOWCASTING_DASHBOARD/data/p12_wages.csv', index=False, float_format="%.2f")
